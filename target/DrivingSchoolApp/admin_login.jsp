...
<head>
    ...
    <title>Admin Login - DriveEase</title>
    <link
    ...
    <style>
        :root {
            ...
            --surface: #13131a;
            --card: #1a1a24;
            --accent: #4f8ef7; /* Different accent for Admin */
            --text: #f0ede8;
            --muted: #8a8799;
...
<body>
    ...
    <div class="login-card">
        ...
        <p class="subtitle">Secure access for school administrators</p>
        ...
        <div class="footer-links">
            <a href="index.jsp">Back to Main Website</a>
        </div>
    </div>
